...
public class ProgramaServicio {
	...
	public static void main(String[] args) throws Exception {
		...
		String id = servicio.crear("223-234-556789113", "Nature", "Lorem ipsum dolor sit amet, consectetur adipiscing elit...", LocalDate.now());
		...
		servicio.addEdicion("223-234-556789113", 230,parseDate("01/03/2024"), parseDate("01/12/2023"), Arrays.asList(tema, tema2 ));		
